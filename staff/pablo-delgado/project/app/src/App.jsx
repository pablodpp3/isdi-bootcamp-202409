...
import { Login, Register, Home, Search, Explorer, Appointments, Profile, SearchAndResults } from './view'
...
export default function App() {
    ...
    <Header onHomeClick={handleHomeClick} onLoggedOut={handleUserLoggedOut} />
        ...
        <Routes>
            ...
            <Route path="/explorer" element={logic.isUserLoggedIn() ? <SearchAndResults /> : <Navigate to="/login" />} />
